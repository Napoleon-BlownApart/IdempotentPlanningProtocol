...
//
#ifndef clfsm_epuckIntersectionByGSM_State_Determine_Direction_Right_h
#define clfsm_epuckIntersectionByGSM_State_Determine_Direction_Right_h
      ...
      namespace FSMepuckIntersectionByGSM
      {
        namespace State
        {
            class Determine_Direction_Right: public CLState
            {
                ...
                {
                public:
                    Transition_1(int toState = 25): CLTransition(toState) {}
