...
//
#ifndef clfsm_epuckIntersectionByGSM_State_Intersection_Check_LeftGS_h
#define clfsm_epuckIntersectionByGSM_State_Intersection_Check_LeftGS_h
      ...
      namespace FSMepuckIntersectionByGSM
      {
        namespace State
        {
            class Intersection_Check_LeftGS: public CLState
            {
                ...
                {
                public:
                    Transition_2(int toState = 14): CLTransition(toState) {}
