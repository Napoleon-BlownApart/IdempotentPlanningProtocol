...
//
#ifndef clfsm_epuckNavigateGridByGSM_State_Determine_Direction_Right_h
#define clfsm_epuckNavigateGridByGSM_State_Determine_Direction_Right_h
      ...
      namespace FSMepuckNavigateGridByGSM
      {
        namespace State
        {
            class Determine_Direction_Right: public CLState
            {
                ...
                {
                public:
                    Transition_1(int toState = 33): CLTransition(toState) {}
