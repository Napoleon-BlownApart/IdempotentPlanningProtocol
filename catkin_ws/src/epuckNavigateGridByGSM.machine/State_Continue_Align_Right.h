...
//
#ifndef clfsm_epuckNavigateGridByGSM_State_Continue_Align_Right_h
#define clfsm_epuckNavigateGridByGSM_State_Continue_Align_Right_h
      ...
      namespace FSMepuckNavigateGridByGSM
      {
        namespace State
        {
            class Continue_Align_Right: public CLState
            {
                ...
                {
                public:
                    Transition_0(int toState = 37): CLTransition(toState) {}
