...
//
#ifndef clfsm_epuckNavigateGridByGSM_State_Intersection_Check_LeftGS_h
#define clfsm_epuckNavigateGridByGSM_State_Intersection_Check_LeftGS_h
      ...
      namespace FSMepuckNavigateGridByGSM
      {
        namespace State
        {
            class Intersection_Check_LeftGS: public CLState
            {
                ...
                {
                public:
                    Transition_2(int toState = 22): CLTransition(toState) {}
