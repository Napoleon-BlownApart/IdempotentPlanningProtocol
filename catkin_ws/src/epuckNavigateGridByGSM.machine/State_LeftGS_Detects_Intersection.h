...
//
#ifndef clfsm_epuckNavigateGridByGSM_State_LeftGS_Detects_Intersection_h
#define clfsm_epuckNavigateGridByGSM_State_LeftGS_Detects_Intersection_h
      ...
      namespace FSMepuckNavigateGridByGSM
      {
        namespace State
        {
            class LeftGS_Detects_Intersection: public CLState
            {
                ...
                {
                public:
                    Transition_0(int toState = 23): CLTransition(toState) {}
