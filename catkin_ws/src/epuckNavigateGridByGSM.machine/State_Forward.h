...
//
#ifndef clfsm_epuckNavigateGridByGSM_State_Forward_h
#define clfsm_epuckNavigateGridByGSM_State_Forward_h
      ...
      namespace FSMepuckNavigateGridByGSM
      {
        namespace State
        {
            class Forward: public CLState
            {
                ...
                {
                public:
                    Transition_5(int toState = 35): CLTransition(toState) {}
