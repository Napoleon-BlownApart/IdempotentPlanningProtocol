...
//
#ifndef clfsm_epuckNavigateGridByGSM_State_Determine_Direction_Left_h
#define clfsm_epuckNavigateGridByGSM_State_Determine_Direction_Left_h
      ...
      namespace FSMepuckNavigateGridByGSM
      {
        namespace State
        {
            class Determine_Direction_Left: public CLState
            {
                ...
                {
                public:
                    Transition_1(int toState = 31): CLTransition(toState) {}
