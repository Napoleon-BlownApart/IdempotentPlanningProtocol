...
//
#ifndef clfsm_epuckNavigateGridByGSM_State_May_Need_Align_Beyond_Intersection_h
#define clfsm_epuckNavigateGridByGSM_State_May_Need_Align_Beyond_Intersection_h
      ...
      namespace FSMepuckNavigateGridByGSM
      {
        namespace State
        {
            class May_Need_Align_Beyond_Intersection: public CLState
            {
                ...
                {
                public:
                    Transition_1(int toState = 28): CLTransition(toState) {}
