...
//
#ifndef clfsm_epuckNavigateGridByGSM_State_Align_After_Left_Turn_h
#define clfsm_epuckNavigateGridByGSM_State_Align_After_Left_Turn_h
      ...
      namespace FSMepuckNavigateGridByGSM
      {
        namespace State
        {
            class Align_After_Left_Turn: public CLState
            {
                ...
                {
                public:
                    Transition_1(int toState = 36): CLTransition(toState) {}
