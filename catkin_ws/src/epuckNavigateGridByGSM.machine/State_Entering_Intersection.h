...
//
#ifndef clfsm_epuckNavigateGridByGSM_State_Entering_Intersection_h
#define clfsm_epuckNavigateGridByGSM_State_Entering_Intersection_h
      ...
      namespace FSMepuckNavigateGridByGSM
      {
        namespace State
        {
            class Entering_Intersection: public CLState
            {
                ...
                {
                public:
                    Transition_0(int toState = 39): CLTransition(toState) {}
