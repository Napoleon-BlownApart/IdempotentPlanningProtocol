...
{
  STRIPS_Problem::clear_if_needed_part_1(strips_problem);
//  gorig_initial_facts = NULL;
	FF_load_problem( pddl_domain_path.c_str(), pddl_problem_path.c_str() );
	//	std::cout << "FF-preprocessing of PDDL problem description" << std::endl;

}

void	build_problem(STRIPS_Problem& strips_problem) {

  FF_build_problem();

}

void	Instantiate_problem(STRIPS_Problem& strips_problem,
					bool ignore_action_costs,
					bool get_detailed_fluent_names ) {
...
void	clean_up(STRIPS_Problem& strips_problem) {
  STRIPS_Problem::clear_if_needed_part_2(strips_problem);
