...
// Epuck Encoder resolution per Radian
#define ENCODER_RESOLUTION 159.23

// Final Alignment after turn is done using GSM, so we set and angle to stop short when turning.
#define ANGLE_STOP_SHORT -10.0


const int32_t RIGHT_ANGLE_TURN = static_cast<int32_t>(ENCODER_RESOLUTION * 3.14159 * ((90.0-ANGLE_STOP_SHORT)/180.0));
const int32_t TURN_AROUND = static_cast<int32_t>(ENCODER_RESOLUTION * 3.14159 * ((180.0-ANGLE_STOP_SHORT)/180.0));
